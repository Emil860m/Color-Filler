...
namespace CreativeSpore.SuperTilemapEditor
{
    ...
    {
        public static string CtrKeyName
        {
            get { return ((Application.platform == RuntimePlatform.OSXEditor) ? "Command" : "Ctrl"); }
        }

        public static string AltKeyName
        {
            get { return ((Application.platform == RuntimePlatform.OSXEditor) ? "Option" : "Alt"); }
        }
