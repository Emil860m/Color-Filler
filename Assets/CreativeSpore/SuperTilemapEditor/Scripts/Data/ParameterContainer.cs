...
namespace CreativeSpore.SuperTilemapEditor
{
    ...
    {
        private const string k_warning_msg_wrongName =
            "Parameter with name {0} of type {1} and value {2} already exists";
        ...
        {
            get { return FindParam(name); }
        }

        [SerializeField] private List<Parameter> m_paramList = new List<Parameter>();
    ...
    public class Parameter
    {
        ...
        [SerializeField] private eParameterType _paramType = eParameterType.None;
        ...
        [SerializeField] private UnityEngine.Object _objectValue = null;
        ...
        {
            Debug.Assert(_paramType == eParameterType.Bool,
                string.Format(k_warning_msg_wrongType, name, _paramType, eParameterType.Bool));
            return _boolValue;
        }

        public int GetAsInt()
        {
            Debug.Assert(_paramType == eParameterType.Int,
                string.Format(k_warning_msg_wrongType, name, _paramType, eParameterType.Int));
            return _intValue;
        }

        public float GetAsFloat()
        {
            Debug.Assert(_paramType == eParameterType.Float,
                string.Format(k_warning_msg_wrongType, name, _paramType, eParameterType.Float));
            return _floatValue;
        }

        public string GetAsString()
        {
            Debug.Assert(_paramType == eParameterType.String,
                string.Format(k_warning_msg_wrongType, name, _paramType, eParameterType.String));
            return _stringValue;
        }

        public UnityEngine.Object GetAsObject()
        {
            Debug.Assert(_paramType == eParameterType.Object,
                string.Format(k_warning_msg_wrongType, name, _paramType, eParameterType.Object));
            return _objectValue;
        }
