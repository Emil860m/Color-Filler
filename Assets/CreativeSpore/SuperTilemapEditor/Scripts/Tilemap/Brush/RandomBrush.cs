...
namespace CreativeSpore.SuperTilemapEditor
{
    public class RandomBrush : TilesetBrush
    {
        ...
        public class RandomTileData
        {
            ...
            [Range(0f, 1f)] public float probabilityFactor;
        }
        ...
        [Tooltip(
            "If activated, the brush id for this brush will be overwritten by the brush id of the selected tile. This should be activated to support animated brushes.")]
...
#pragma warning disable 618
            if ((RandomTileList == null || RandomTileList.Count == 0) && RandomTiles != null && RandomTiles.Count > 0)
            {
                ...
                RandomTileList = new List<RandomTileData>(RandomTiles.Select(x =>
                    new RandomTileData() {tileData = x, probabilityFactor = 1f}));
                RandomTiles = null;
            }
