    ...
    public class CarpetBrushEditor : TilesetBrushEditor
    {
        ...
        */
        ...
        public override void OnInspectorGUI()
        {
            ...
            m_brushTileGridControl.Display(target, m_brush.TileIds, s_tileIdxMap, 3, 3, m_brush.Tileset.VisualTileSize,
                s_tileIdxMap);
            ...
            m_interiorCornersControl.Display(target, m_brush.InteriorCornerTileIds, s_interiorCornersIdxMap, 2, 2,
                m_brush.Tileset.VisualTileSize, s_interiorCornersSymbolIdx);
