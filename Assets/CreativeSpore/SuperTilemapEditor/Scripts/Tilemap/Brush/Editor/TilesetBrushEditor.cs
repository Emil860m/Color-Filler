...
namespace CreativeSpore.SuperTilemapEditor
{
    ...
    public class TilesetBrushEditor : Editor
    {
        ...
        public void DoInspectorGUI()
        {
            ...
            m_autotilingMode.intValue = System.Convert.ToInt32(
                EditorCompatibilityUtils.EnumMaskField(new GUIContent("Autotiling Mode", sAutotilingModeTooltip),
                    brush.AutotilingMode));
