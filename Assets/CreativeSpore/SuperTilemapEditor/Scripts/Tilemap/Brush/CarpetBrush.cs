    ...
    public class CarpetBrush : RoadBrush
    {
        ...
        public override uint[] GetSubtiles(STETilemap tilemap, int gridX, int gridY, uint tileData)
        {
            ...
            if (s_needsSubTiles)
            {
                ...
                {
                    aSubTileData = new uint[]
                    {
                        InteriorCornerTileIds[0], InteriorCornerTileIds[1], InteriorCornerTileIds[2],
                        InteriorCornerTileIds[3]
                    };
                }
                else
                {
                    aSubTileData = new uint[]
                        {TileIds[s_neighIdx], TileIds[s_neighIdx], TileIds[s_neighIdx], TileIds[s_neighIdx]};
                }
        ...
        public override Vector2[] GetMergedSubtileColliderVertices(STETilemap tilemap, int gridX, int gridY,
            uint tileData)
        {
            ...
            if (subTiles != null)
            {
                ...
                for (int i = 0; i < subTiles.Length; ++i)
                {
                    ...
                    if (tile != null && tile.collData.type != eTileCollider.None)
                    {
                        ...
                        if ((subTileData & (Tileset.k_TileFlag_FlipH | Tileset.k_TileFlag_FlipV |
