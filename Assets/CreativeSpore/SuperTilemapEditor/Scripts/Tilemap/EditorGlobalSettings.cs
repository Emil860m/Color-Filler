...
namespace CreativeSpore.SuperTilemapEditor
{
    public static class EditorGlobalSettings
    {
        ...
        {
            return new Color32((byte) ((value >> 24) & 0xFF), (byte) ((value >> 16) & 0xFF),
        ...
        public static Color TilemapColliderColor
        {
            get
            {
                return IntToColor32(PlayerPrefs.GetInt("STE_TilemapColliderColor",
                    Color32ToInt(new Color32(0, 255, 0, 160))));
            }
        ...
        public static Color TilemapGridColor
        {
            get
            {
                return IntToColor32(PlayerPrefs.GetInt("STE_TilemapGridColor",
                    Color32ToInt(new Color32(255, 255, 255, 60))));
            }
