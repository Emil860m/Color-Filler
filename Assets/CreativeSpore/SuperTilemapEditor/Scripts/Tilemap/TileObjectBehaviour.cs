...
namespace CreativeSpore.SuperTilemapEditor
{
    ...
    public class TileObjectBehaviour : MonoBehaviour
    {
        ...
        public static void DoOnTilePrefabCreation(TilemapChunk.OnTilePrefabCreationData data,
            SpriteRenderer spriteRenderer, bool changeSpriteOnly)
        {
        ...
        public static Sprite GetOrCreateSprite(TilemapChunk.OnTilePrefabCreationData data)
        {
            ...
            if (tile != null)
            {
                ...
                {
                    sprite = Sprite.Create(data.ParentTilemap.Tileset.AtlasTexture, spriteUV, new Vector2(.5f, .5f),
                        pixelsPerUnit);
