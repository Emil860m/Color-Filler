...
namespace CreativeSpore.SuperTilemapEditor
{
    public class TilePropertiesWindow : EditorWindow
    {
        ...
        {
            s_instance =
                (TilePropertiesWindow) EditorWindow.GetWindow(typeof(TilePropertiesWindow), false, "Tile Properties",
                    true);
        ...
        public TilePropertiesControl TilePropertiesControl
        {
            get { return m_tilePropertiesControl; }
        }

        [SerializeField] TilePropertiesControl m_tilePropertiesControl = new TilePropertiesControl();
