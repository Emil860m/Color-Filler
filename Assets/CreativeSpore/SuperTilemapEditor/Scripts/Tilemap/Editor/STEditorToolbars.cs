...
namespace CreativeSpore.SuperTilemapEditor
{
    public class STEditorToolbars
    {
        ...
        public static STEditorToolbars Instance
        {
            get
            {
                if (s_instance == null) s_instance = new STEditorToolbars();
                return s_instance;
            }
        }
        ...
        private STEditorToolbars()
        {
            List<GUIContent> guiContentList = new List<GUIContent>()
            {
                ...
                new GUIContent(ToolIcons.GetToolTexture(ToolIcons.eToolIcon.FlipH),
                    "Flip Horizontal (" + ShortcutKeys.k_FlipH + ")"),
                new GUIContent(ToolIcons.GetToolTexture(ToolIcons.eToolIcon.FlipV),
                    "Flip Vertical (" + ShortcutKeys.k_FlipV + ")"),
                new GUIContent(ToolIcons.GetToolTexture(ToolIcons.eToolIcon.Rot90),
                    "Rotate 90 clockwise (" + ShortcutKeys.k_Rot90 + "); anticlockwise (" + ShortcutKeys.k_Rot90Back +
                    ")"),
            ...
            {
                new GUIContent(ToolIcons.GetToolTexture(ToolIcons.ePaintModeIcon.Pencil),
                    "Paint (" + ShortcutKeys.k_PencilTool + ")"),
                new GUIContent(ToolIcons.GetToolTexture(ToolIcons.ePaintModeIcon.Line),
                    "Line (" + ShortcutKeys.k_LineTool + ")"),
                new GUIContent(ToolIcons.GetToolTexture(ToolIcons.ePaintModeIcon.Rect),
                    "Rectangle (" + ShortcutKeys.k_RectTool + ")"),
                new GUIContent(ToolIcons.GetToolTexture(ToolIcons.ePaintModeIcon.FilledRect),
                    "Filled Rectangle (" + ShortcutKeys.k_RectTool + ")"),
                new GUIContent(ToolIcons.GetToolTexture(ToolIcons.ePaintModeIcon.Ellipse),
                    "Ellipse (" + ShortcutKeys.k_EllipseTool + ")"),
                new GUIContent(ToolIcons.GetToolTexture(ToolIcons.ePaintModeIcon.FilledEllipse),
                    "Filled Ellipse (" + ShortcutKeys.k_EllipseTool + ")"),
            };
            brushPaintToolbar = new ToolbarControl(guiContentList);
            brushPaintToolbar.OnToolSelected += OnToolSelected_BrushPaintToolbar;
        }

        private void OnToolSelected_BrushPaintToolbar(ToolbarControl source, int selectedToolIdx,
            int prevSelectedToolIdx)
        {
