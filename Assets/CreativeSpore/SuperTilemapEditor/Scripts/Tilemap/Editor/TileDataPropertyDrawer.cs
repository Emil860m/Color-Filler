    ...
    public class TileDataPropertyDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    Debug.LogWarning("No STETilemap was found as parent of the component owner of the property",
        ...
        public static void TileDataField(Rect position, GUIContent label, SerializedProperty property, Tileset tileset)
        {
            ...
            EditorGUI.PropertyField(
                new Rect(position.x, position.y + k_TilePreviewSize, position.width,
                    position.height - k_TilePreviewSize), property, label);
        }
    }
}