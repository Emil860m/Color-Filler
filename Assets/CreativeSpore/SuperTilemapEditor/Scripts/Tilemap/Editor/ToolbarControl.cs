...
namespace CreativeSpore.SuperTilemapEditor
{
    ...
    {
        public delegate void OnToolSelectedDelegate(ToolbarControl source, int selectedToolIdx,
        ...
        public void DoGUI(Vector2 position, Vector2 buttonSize, Color bgColor, Color outlineColor)
        {
            ...
            int buttonPadding = 4;
            Rect rToolBtn = new Rect(buttonPadding, buttonPadding, rToolBar.size.y - 2 * buttonPadding,
                rToolBar.size.y - 2 * buttonPadding);
        ...
        {
            int iconPadding = 6;
            Rect rToolIcon = new Rect(rToolBtn.x + iconPadding, rToolBtn.y + iconPadding,
                rToolBtn.size.y - 2 * iconPadding, rToolBtn.size.y - 2 * iconPadding);
