...
namespace CreativeSpore.SuperTilemapEditor
{
    public class TileSelectionWindow : EditorWindow
    {
        ...
        {
            s_instance =
                (TileSelectionWindow) EditorWindow.GetWindow(typeof(TileSelectionWindow), false, "Tile Palette", true);
        ...
        public TilesetControl TilesetControl
        {
            get { return m_tilesetControl; }
        }

        [SerializeField] TilesetControl m_tilesetControl = new TilesetControl();
